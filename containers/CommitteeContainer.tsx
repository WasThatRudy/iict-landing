...
const PROGRAM_COMMITTEE: CommitteeMember[] = [
  { id: "pc-1",  image: img("abhijat-vichare.png"),          name: "Abhijat Vichare",       institute: "ACM India",        position: "(PC Member)", link: "https://www.linkedin.com/in/abhijat-vichare-8288222/" },
  { id: "pc-2",  image: img("ashish-mishra.jpg"),            name: "Ashish Mishra",          institute: "IIT Hyderabad",    position: "(PC Member)", link: "https://www.linkedin.com/in/ashishmishraiisc/" },
  { id: "pc-3",  image: img("img2_DD.svg"),                  name: "Dibyendu Das",           institute: "Qualcomm",         position: "(PC Member)", link: "https://www.linkedin.com/in/dibyendu-das-80341b8/" },
  { id: "pc-4",  image: img("saiyedul-islam.jpg"),           name: "Dr. Saiyedul Islam",     institute: "AMD",              position: "(PC Member)", link: "https://in.linkedin.com/in/saiyedulislam" },
  { id: "pc-5",  image: img("unnikrishnan-c.png"),           name: "Dr. Unnikrishnan C",     institute: "IIT Palakkad",     position: "(PC Member)", link: "https://unnikrishnan-c.github.io/" },
  { id: "pc-6",  image: img("girish-bharambe.jpg"),          name: "Girish Bharambe",        institute: "NVIDIA",           position: "(PC Member)", link: "https://www.linkedin.com/in/girish-bharambe-7444349/" },
  { id: "pc-7",  image: img("jyothi-vedurada.jpg"),          name: "Jyothi Vedurada",        institute: "IIT Hyderabad",    position: "(PC Member)", link: "https://www.linkedin.com/in/jyothi-vedurada-87084226/" },
  { id: "pc-8",  image: img("img4_KN.svg"),                  name: "Kartik Nagar",           institute: "IIT Madras",       position: "(PC Member)", link: "https://kartiknagar.github.io/" },
  { id: "pc-9",  image: img("kc-sivaramakrishnan.jpg"),      name: "KC Sivaramakrishnan",    institute: "IIT Madras",       position: "(PC Member)", link: "https://www.linkedin.com/in/kc-sivaramakrishnan-25061a14/" },
  { id: "pc-10", image: img("img6_KVR.svg"),                 name: "Komondoor V Raghavan",   institute: "IISc, Bangalore",  position: "(PC Member)", link: "https://www.linkedin.com/in/komondoor-v-raghavan-882b1b6/" },
  { id: "pc-11", image: img("img5_KRN.svg"),                 name: "Krishna Nandivada",      institute: "IIT Madras",       position: "(PC Member)", link: "http://www.cse.iitm.ac.in/~krishna/" },
  { id: "pc-12", image: img("img7_MT.svg"),                  name: "Manas Thakur",           institute: "IIT Bombay",       position: "(PC Member)", link: "https://www.cse.iitb.ac.in/~manas/" },
  { id: "pc-13", image: img("nikhil-hegde.jpg"),             name: "Nikhil Hegde",           institute: "IIT Dharwad",      position: "(PC Member)", link: "https://hegden.github.io/" },
  { id: "pc-14", image: img("img3_GR.svg"),                  name: "R Govindarajan",         institute: "IISc, Bangalore",  position: "(PC Chair)",  link: "https://eecs.iisc.ac.in/people/govindarajan-r/" },
  { id: "pc-15", image: img("img8_RU.svg"),                  name: "Ramakrishna Upadrasta",  institute: "IIT Hyderabad",    position: "(PC Member)", link: "https://people.iith.ac.in/ramakrishna/" },
  { id: "pc-16", image: img("img9_RR.svg"),                  name: "Ramana Radhakrishnan",   institute: "NVIDIA",           position: "(PC Chair)",  link: "https://in.linkedin.com/in/themadrasi" },
